...
/**
 * The `Toast` slice of the @civitai/components stylesheet —
 * a standalone, layered sheet carrying the shared `[data-civitai-ui]` base
 * rule plus this section only. Identical to dist/css/toast-region.css.
 *
 * Components in this slice: toast-region, toast.
 *
...
export const toastRegionCss: string = css;
