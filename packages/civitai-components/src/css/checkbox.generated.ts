...
/**
 * The `Checkbox / Radio (issue #181 F6)` slice of the @civitai/components stylesheet —
 * a standalone, layered sheet carrying the shared `[data-civitai-ui]` base
 * rule plus this section only. Identical to dist/css/checkbox.css.
 *
 * Components in this slice: checkbox, radio.
 *
