...
/**
 * The `Tooltip` slice of the @civitai/components stylesheet —
 * a standalone, layered sheet carrying the shared `[data-civitai-ui]` base
 * rule plus this section only. Identical to dist/css/tooltip.css.
 *
 * Components in this slice: tooltip.
 *
...
export const tooltipCss: string = css;
