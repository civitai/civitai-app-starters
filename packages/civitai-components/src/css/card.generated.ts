...
/**
 * The `Card` slice of the @civitai/components stylesheet —
 * a standalone, layered sheet carrying the shared `[data-civitai-ui]` base
 * rule plus this section only. Identical to dist/css/card.css.
 *
 * Components in this slice: card.
 *
...
export const cardCss: string = css;
