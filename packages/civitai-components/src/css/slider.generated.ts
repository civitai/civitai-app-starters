...
/**
 * The `Slider` slice of the @civitai/components stylesheet —
 * a standalone, layered sheet carrying the shared `[data-civitai-ui]` base
 * rule plus this section only. Identical to dist/css/slider.css.
 *
 * Components in this slice: slider.
 *
...
export const sliderCss: string = css;
