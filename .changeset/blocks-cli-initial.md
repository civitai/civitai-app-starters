---
'@civitai/blocks-cli': major
---

Initial release of `@civitai/blocks-cli` (1.0.0): the `civitai` bin for scaffolding and shipping Civitai App Blocks.
...
Depends on `@civitai/app-sdk ^0.3` (for `defineBlock` + `BLOCK_SCOPES`) and `commander ^12`.
